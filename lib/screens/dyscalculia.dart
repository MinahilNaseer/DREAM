...
class _DyscalculiaLevelState extends State<DyscalculiaLevel> {
  ...
  Future<void> _speakQuestion() async {
    ...
    String ttsText =
        questionText.replaceAll("+", "plus").replaceAll("-", "minus") +
            " equals what?";
  ...
  Future<void> _checkAnswer(String answer) async {
    double responseTime =
        DateTime.now().difference(questionStartTime!).inSeconds.toDouble();
    ...
    try {
      ...
      for (var childDoc in childrenSnapshot.docs) {
        ...
        if (response.statusCode == 200) {
          ...
          print(
              "Failed for child ($selectedChildId). Status: ${response.statusCode}");
        }
      }
    } catch (e) {
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    if (reportSnapshot.docs.isNotEmpty) {
                      final latestReport = reportSnapshot.docs.first.data();
                      final reportText = latestReport['report'];
                      final timestamp = latestReport['timestamp'];
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => DyscalculiaReportPage(
                            ...
                            childId: widget.childData['childId'],
